...
class SAM2UNet(nn.Module):
    ...
    """
    def __init__(self, checkpoint_path=None, model_cfg="./configs/sam2.1/sam2.1_hiera_s.yaml", device="cuda", output_channel = None):
        ...
        self.encoder.patch_embed.proj = nn.Conv2d(1, 96, kernel_size=(7, 7), stride=(4, 4), padding=(3, 3))
        ...
        # 定义PatchExpand
        self.patchexpand = Final_PatchExpand2D(dim=96, dim_scale=4)

        # 定义输出卷积层
        self.outc = OutConv(in_channels=24, out_channels=output_channel)  # 最终输出
...
if __name__ == "__main__":
    ...
    # 模型配置和检查点路径
    sam2_checkpoint = "./network/sam2/checkpoints/sam2.1_hiera_small.pt"
