"""
冻结Encoder的SAM2UNet网络
在LA上进行全监督学习的尝试
使用Tiny版本的SAM2UNet,因为large版本的显存不够
"""
...
class SAM2VNet(nn.Module):
    ...
    def __init__(self, checkpoint_path=None, model_cfg=None, device="cuda", output_channel=None):
        ...
        self.encoder.patch_embed.proj = nn.Conv2d(
            1, 96, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3)) # Large专用
...
if __name__ == "__main__":
    ...
    # 设置配置目录
    sam2_checkpoint = "./sam2_configs/sam2.1_hiera_small.pt"
    ...
    summary(model=model, input_size=(1, 1, 112, 112, 80))  # 3D输入
