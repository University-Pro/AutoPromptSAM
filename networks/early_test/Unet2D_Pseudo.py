...
class UNet_Branch1(nn.Module):
    def __init__(self, n_channels, n_classes):
        super(UNet_Branch1, self).__init__()
...
class UNet_Branch2(nn.Module):
    def __init__(self, n_channels, n_classes):
        super(UNet_Branch2, self).__init__()
        self.n_channels = n_channels
        self.n_classes = n_classes
...
class UNet_Full(nn.Module):
    def __init__(self, n_channels, n_classes):
        ...
        self.n_channels = n_channels
        self.n_classes = n_classes
        self.unet_branch1 = UNet_Branch1(
            n_channels=n_channels, n_classes=n_classes)
        self.unet_branch2 = UNet_Branch2(
            n_channels=n_channels, n_classes=n_classes)

    def forward(self, x):
        branch1_output = self.unet_branch1(x)
        branch2_output = self.unet_branch2(x)
...
if __name__ == "__main__":
    ...
    model = UNet_Full(n_channels=1, n_classes=2).to(device)
