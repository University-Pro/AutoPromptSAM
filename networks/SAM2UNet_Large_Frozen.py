...
class SAM2UNet(nn.Module):
    ...
    """
    def __init__(self, checkpoint_path=None, model_cfg="./configs/sam2.1/sam2.1_hiera_.yaml", device="cuda", output_channel = None):
        ...
        if checkpoint_path:
            ...
            sam2 = build_sam2(config_file=model_cfg, ckpt_path=None, device="cuda", apply_postprocessing=False)

        # 删除没有必要的模块
        del sam2.sam_mask_decoder
        del sam2.sam_prompt_encoder
        del sam2.memory_encoder
        del sam2.memory_attention
        del sam2.mask_downsample
        del sam2.obj_ptr_tpos_proj
        del sam2.obj_ptr_proj
        del sam2.image_encoder.neck
        ...
        for name, param in self.encoder.named_parameters():
            if "blocks" in name:  # 只冻结 blocks 中的参数
