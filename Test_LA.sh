...
PTH_DIR="./result/SAM3D_VNet_SSL/LA_16_SemiSupervised_V9/Pth_Part1"  # 修改为你存放模型的目录

# Directory to save logs
LOG_DIR="./result/SAM3D_VNet_SSL/LA_16_SemiSupervised_V9/Test_Part1"  # 修改为你保存日志的目录
