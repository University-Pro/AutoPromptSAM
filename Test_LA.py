...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_load", type=str, default='./result/youmodelname/Pth/model_epoch_xx_checkpoint.pth', help='The path of the checkpoint')
    parser.add_argument("--log_path", type=str, default='./result/youmodelname/Test/running.log', help='The path of the test log')
    ...
    net = load_model(model, option.model_load, device)
    logging.info(f"Model successfully loaded from {option.model_load}")
    net.eval() # 进入评估模式
