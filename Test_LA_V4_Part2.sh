...
PTH_DIR="./result/SAM3D_VNet_SSL/LA_16_SemiSupervised_PretrainNone/Pth_Part2"  # 修改为你存放模型的目录

# Directory to save logs
LOG_DIR="./result/SAM3D_VNet_SSL/LA_16_SemiSupervised_PretrainNone/Test_Part2"  # 修改为你保存日志的目录
...
for MODEL_PATH in $PTH_DIR/*.pth; do
  ...
  python -m Test_LA_V4_Part2 \
    --model_name "SAM3D_VNet_SSL_V4" \
